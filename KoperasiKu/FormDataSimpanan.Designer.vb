...
Partial Class FormDataSimpanan
    ...
    Private Sub InitializeComponent()
        ...
        lAnggota.Font = New Font("Lucida Sans", 9.0F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        lAnggota.Location = New Point(35, 92)
        lAnggota.Name = "lAnggota"
        lAnggota.Size = New Size(115, 17)
        lAnggota.TabIndex = 0
        ...
        lJenis.Font = New Font("Lucida Sans", 9.0F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        lJenis.Location = New Point(36, 130)
        lJenis.Name = "lJenis"
        lJenis.Size = New Size(120, 17)
        lJenis.TabIndex = 1
        ...
        lJumlah.Font = New Font("Lucida Sans", 9.0F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        lJumlah.Location = New Point(21, 206)
        lJumlah.Name = "lJumlah"
        lJumlah.Size = New Size(134, 17)
        lJumlah.TabIndex = 3
        ...
        cbJnsSimpanan.Font = New Font("Lucida Sans", 9.0F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        ...
        cbNmAnggota.Font = New Font("Lucida Sans", 9.0F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        ...
        lTotalSimpan.Font = New Font("Lucida Sans", 9.0F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        lTotalSimpan.Location = New Point(177, 550)
        lTotalSimpan.Name = "lTotalSimpan"
        lTotalSimpan.Size = New Size(0, 20)
        lTotalSimpan.TabIndex = 18
        '
        ' lTotalLabel
        '
        lTotalLabel.AutoSize = True
        lTotalLabel.Font = New Font("Lucida Sans", 9.0F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        lTotalLabel.Location = New Point(36, 550)
        lTotalLabel.Name = "lTotalLabel"
        lTotalLabel.Size = New Size(155, 17)
        ...
        lDaftarTitle.Font = New Font("Lucida Sans", 14.0F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        lDaftarTitle.Location = New Point(238, 259)
        lDaftarTitle.Name = "lDaftarTitle"
        lDaftarTitle.Size = New Size(444, 30)
        ...
        lTitle.Font = New Font("Lucida Sans", 18.0F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        lTitle.Location = New Point(275, 19)
        lTitle.Name = "lTitle"
        lTitle.Size = New Size(370, 31)
        lTitle.TabIndex = 10
